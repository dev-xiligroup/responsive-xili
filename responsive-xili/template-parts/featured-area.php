...
<div id="featured" class="grid col-940">
	...
	<div id="featured-content" class="grid col-460">
		...
		<h1 class="featured-title">
			...
			if ( isset( $responsive_options['home_headline'] ) && $db && $empty )
				echo translate ($responsive_options['home_headline'], 'responsive' );
			else {
		...
		<h2 class="featured-subtitle">
			...
			if ( isset( $responsive_options['home_subheadline'] ) && $db && $empty )
				echo translate ( $responsive_options['home_subheadline'], 'responsive' );
			else
		...
		if ( isset( $responsive_options['home_content_area'] ) && $db && $empty ) {
			echo do_shortcode( wpautop( translate ($responsive_options['home_content_area'], 'responsive' ) ) );
		} else {
			...
			<div class="call-to-action">
				...
				<a href="<?php echo $responsive_options['cta_url']; ?>" class="blue button">
					...
					if ( isset( $responsive_options['cta_text'] ) && $db && $emtpy_cta )
						echo translate ( $responsive_options['cta_text'], 'responsive' );
					else
	...
	<div id="featured-image" class="grid col-460 fit">
		...
		<?php echo do_shortcode( wpautop( translate ( $featured_content, 'responsive' ) ) ); ?>
